    ...
    <section class="py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-10 lg:gap-0">
                ...
                <div class="relative group w-full h-full lg:rounded-l-2xl rounded-2xl overflow-hidden shadow-xl">
                    <img src="https://pagedone.io/asset/uploads/1696488602.png" alt="Contact Us Image"
                        class="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-105" />
                    <div class="absolute inset-0 bg-indigo-700 opacity-60"></div>
                    
                    <div class="absolute top-11 left-11 right-11">
                        <h1 class="font-manrope text-white text-4xl font-bold leading-10">Contact us</h1>
                    </div>
                    
                    <div class="absolute bottom-0 w-full lg:p-11 p-5">
                        <div class="bg-white rounded-lg p-6">
                            <a href="tel:09187224851" class="flex items-center mb-6">
                                ...
                                <h5 class="text-black text-base font-normal leading-6 ml-5">091-8722-4851</h5>
                            </a>
                            <a href="mailto:andrianelemento41@gmail.com" class="flex items-center mb-6">
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h5 class="text-black text-base font-normal leading-6 ml-5">
                                    andrianelemento41@gmail.com</h5>
                            </a>
                            <a href="javascript:;" class="flex items-center">
                                ...
                                <h5 class="text-black text-base font-normal leading-6 ml-5">Magallanes, Sorsogon</h5>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-5 lg:p-11 rounded-2xl lg:rounded-r-2xl lg:rounded-l-none shadow-xl">
                    ...
                    <textarea
                        class="w-full h-40 resize-none text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-7 rounded-2xl border border-gray-200 focus:outline-none p-4 mb-10"
